package com.tbsurvey.trlbhxf.data.http.net.function;
...
public class RetryWithDelay implements Function<Observable<? extends Throwable>, Observable<?>> {
    ...
    public Observable<?> apply(@NonNull Observable<? extends Throwable> observable) throws Exception {
        return observable
                .zipWith(Observable.range(1, maxRetries + 1), (BiFunction<Throwable, Integer, Wrapper>) (throwable, integer) -> new Wrapper(throwable, integer)).flatMap((Function<Wrapper, ObservableSource<?>>) wrapper -> {
