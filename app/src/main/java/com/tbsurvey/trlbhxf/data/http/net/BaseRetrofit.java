package com.tbsurvey.trlbhxf.data.http.net;
...
import com.tbsurvey.trlbhxf.data.http.net.converter.GsonConverterBodyFactory;
import com.tbsurvey.trlbhxf.data.http.net.interceptor.CaheInterceptor;
import com.tbsurvey.trlbhxf.data.http.net.interceptor.HeaderInterceptor;
import com.tbsurvey.trlbhxf.data.http.net.token.TokenInterceptor;
        ...
        if (retrofit == null) {
            synchronized (BaseRetrofit.class) {
                if (retrofit == null) {
                    ...
                    //设置 请求的缓存的大小跟位置
                    File cacheFile = new File(MyApplication.getMyApplication().getApplicationContext().getCacheDir(), "cache");
...
//                          .cookieJar(new CookieJarImpl(new PersistentCookieStore(App.getContext()))); //cookie 相关
                            ...
                            .addInterceptor(new CaheInterceptor(MyApplication.getMyApplication().getApplicationContext()))
