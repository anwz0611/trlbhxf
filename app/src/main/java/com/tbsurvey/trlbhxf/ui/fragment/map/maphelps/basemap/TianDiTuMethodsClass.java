...
/**
 * author:jxj on 2020/12/16 14:25
 * e-mail:592296083@qq.com
 * desc  :
 */
public class TianDiTuMethodsClass {
    //天地图官网申请key
    public static final String key = "64a7440068a2bbc276c11927b54458f4";
    ...
    private static final String URL_VECTOR_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=w&x={col}&y={row}&l={level}&tk=" + key;
    ...
    public static WebTiledLayer CreateTianDiTuTiledLayer(String layerType,String cachePath) {
        return CreateTianDiTuTiledLayer(getTianDiTuLayerType(layerType),cachePath);
    }

    public static CacheTiledLayer CreateTianDiTuTiledLayer(LayerType layerType,String cachePath) {
        CacheTiledLayer webTiledLayer = null;
        String mainUrl = "";
        String mainName = "";
        ...
        try {
            ...
            webTiledLayer = new CacheTiledLayer(
                    mainUrl,
                    SubDomain,
                    mainTileInfo,
                    mainEnvelope,cachePath);
