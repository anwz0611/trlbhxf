...
package com.tbsurvey.trlbhxf.ui.fragment.imagemanage.adapter.downadapter;
...
import com.tbsurvey.trlbhxf.wight.HorizontalProgressBarWithNumber;
import com.tbsurvey.trlbhxf.wight.SubStateLinearLayout;
...
public class DownloadAdapter extends AbsRVAdapter<AbsEntity, DownloadAdapter.SimpleHolder> {
  ...
  private void cancel(AbsEntity entity) {
    if (!AppUtils.chekEntityValid(entity)) {
      return;
    }
